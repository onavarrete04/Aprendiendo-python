...
class Aplicacion:
    def __init__(self):
        ...
        # con el increment no serian valores consecutivos sino de 3 en 3
        """dias=("lunes", "martes", "miércoles","jueves","viernes","sábado","domingo")
        self.spinbox1=ttk.Spinbox(self.ventana1, values=dias,  state='readonly')        
        self.spinbox1.set(dias[0])  ->> con esta forma se puede hacer el spinbox con texto, utilizando una tupla"""
        self.spinbox1.set(0)        
